#!/usr/bin/env python3
"""
Recupero codici sconto Groupon da shopilo.it
Sursa: https://shopilo.it/negozi/groupon.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/groupon.it"
STORE_NAME = "Groupon"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Groupon da shopilo.it"""
    headers = {
