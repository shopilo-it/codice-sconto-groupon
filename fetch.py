#!/usr/bin/env python3
"""
Fetch coduri de reducere Groupon de pe shopilo.it
Sursa: https://shopilo.it/magazin/groupon.it
"""
...
SHOPILO_URL = "https://shopilo.it/magazin/groupon.it"
STORE_NAME = "Groupon"


def fetch_coupons(url=SHOPILO_URL):
    """Returneaza lista de cupoane active pentru Groupon de pe shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-groupon)"
    }
    try:
