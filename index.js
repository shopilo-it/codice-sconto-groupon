#!/usr/bin/env node
/**
 * Fetch coduri reducere Groupon de pe shopilo.it
 * Homepage: https://shopilo.it/magazin/groupon.it
 */

const SHOPILO_URL = "https://shopilo.it/magazin/groupon.it";
const STORE_NAME  = "Groupon";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-it/codice-sconto-groupon)" }
  });
